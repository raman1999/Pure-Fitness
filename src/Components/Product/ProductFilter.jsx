...
export function ProductFilter() {
  ...
  return (
    <aside className="filter-list">
      ...
      <button
        type="button"
        className="bg-theme txt-white txt-bold btn-clear"
        onClick={() => filterDispatch({ type: "CLEAR_ALL_FILTERS" })}
      >
        Clear All
      </button>

      <div className="sort-by-price flex-column bd-bottom">
        <h4>Sort By Price</h4>
        <div>
          <input
            type="radio"
      ...
      <div className="sort-by-price-range flex-column bd-bottom">
        <h4>
          Price Range: <span className="txt-normal"> 0 to {priceRange}</span>
        </h4>
      ...
      <div className="sort-by-filter flex-column bd-bottom">
      ...
      <div className="sort-by-brand flex-column bd-bottom">
        <h4>Brands</h4>
        {brands.map((brand) => (
          <div key={brand}>
            <input
      ...
      <div className="sort-by-category flex-column bd-bottom">
        <h4>Categories</h4>
