      ...
      <form className=" form-container flex-column" onSubmit={signupHandler}>
        ...
        <div className="input-container">
          <div className="input-box">
            <label className="label txt-bgDark">
              First Name<span className="txt-theme">*</span>
            </label>
            <span>
              <input
                className="txt-input"
          ...
          <div className="input-box">
            <label className="label txt-bgDark">
              Last Name<span className="txt-theme">*</span>
            </label>
            <span>
              <input
                className="txt-input"
          ...
          <div className="input-box">
            <label className="label txt-bgDark">
              Email<span className="txt-theme">*</span>
            </label>
            <span>
              <input
                className="txt-input"
          ...
          <div className="input-box">
            <label className="label txt-bgDark">
              Password<span className="txt-theme">*</span>
            </label>
            <span>
              <PasswordField
          ...
          <div className="input-box">
            <label className="label txt-bgDark">
              Confirm Password<span className="txt-theme">*</span>
            </label>
            <span>
              <PasswordField
        ...
        <div className="submit-container">
          ...
          <p className="txt-gray">
            ...
            <Link to="/login" className="link bd-bottom theme-shade-2 l-sp-1">
              {" "}
              Login here
            </Link>
          </p>
        ...
        {serverError && (
          <div className="txt-bgFailure padding-box">{serverError}</div>
        )}
      </form>
    </section>
  );
